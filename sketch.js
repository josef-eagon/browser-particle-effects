...
function draw() {
  ...
  if (frameCount % 5 === 0) {
    for (let i = 0; i < 20; i++) { // Create 6 particles at a time
...
class Particle {
  constructor(x, y) {
    ...
    this.lifespan = 350;     // Starting alpha value (fully opaque)
  ...
  display() {
    ...
    noStroke();
    fill(0, 200, 0, this.lifespan); // White with alpha based on lifespan
